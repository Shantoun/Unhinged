...
if user_id:
    ...
    if not has_profile:
        ...
        col1.plotly_chart(fig_day_radial, width="stretch", config={"scrollZoom": False, "doubleClick": False, "displaylogo": False, "dragmode": False})
        col2.plotly_chart(fig_time_radial, width="stretch", config={"scrollZoom": False, "doubleClick": False, "displaylogo": False, "dragmode": False})

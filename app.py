...
# if not logged in → show login screen
    ...
    with tab1:
        st.caption("""
            How you use a dating app affects your results. Sending likes or comments at the wrong times can reduce reach over time, even with a strong profile. This can leave you well...
